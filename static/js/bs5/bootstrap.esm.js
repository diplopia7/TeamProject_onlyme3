...
/**
 * --------------------------------------------------------------------------
 * Bootstrap (v5.2.0-beta1): util/SemiProjectV2_2.js
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
 * --------------------------------------------------------------------------
 */
/**
  ...
  _getTemplateFactory(content) {
    if (this._templateFactory) {
      ...
      this._templateFactory = new TemplateFactory({ ...this._config,
        ...
        // to override SemiProjectV2_2.content in case of popover
        content,
...
class ScrollSpy extends BaseComponent {
  constructor(element, config) {
    super(element, config); // this._element is the observablesContainer and SemiProjectV2_2.target the menu links wrapper
